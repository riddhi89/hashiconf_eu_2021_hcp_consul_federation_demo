...
cd hcp_consul/
CLUSTERID=$(terraform output -raw eu_west_cluster)
cd ../
...
cd ../hcp_consul/
terraform output -raw eu_west_bootstrap_secret > ../${DIR}/consul_bootstrap_secret.yaml
CONSUL_HTTP_ADDR=$(terraform output eks_eu_west_api_endpoint)
cd ../$DIR
